package com.anna.healthyeats.network.constants
...
object ApiConstants {
  ...
  val BASE_URL = StringBuilder("https://api.edamam.com/api/recipes/v2?")
    ...
    .append("$SEARCH_QUERY_APP_ID_PARAMETER=${BuildConfig.EDAMAM_APP_ID}&") //append app_id
    .append("$SEARCH_QUERY_API_KEY_PARAMETER=${BuildConfig.EDAMAM_API_KEY}") //append api_key
    .toString()
}